...
const coords = districtCoordinates[key] || [-29.6, 27.5];
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      ...
      <div className="mb-6 h-screen bg-white rounded-xl shadow-sm border border-slate-200 p-4">
        <h2 className="text-lg font-semibold text-text mb-3">
          Disaster Locations & Analytics
        </h2>
        {error && (
        ...
        <div className="h-[calc(100vh-180px)] rounded-lg overflow-hidden bg-slate-100">
...
function SummaryCard({ title, value, subtitle, bgColor }) {
  return (
